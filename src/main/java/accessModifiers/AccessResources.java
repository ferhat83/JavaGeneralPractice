...
public class AccessResources {
	...
	// default & public => make variable (or method)accessible from different class trough
	// objects. same as public (No need to add it in front of a variable de make it
	// default )
	// private: NO access from different class (can't access at all)
	// protected: can't access from different folder using just object (we should
	// use sub class (extends) & object(or just extend & static))
	int hours = 3;
